...
public class AccessTokenFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        String authorizationHeader = extractAuthorizationHeaderAsString(
                request);
        AccessToken accessToken = tokenVerifier.validateAuthorizationHeader(
                authorizationHeader);
        return new UsernamePasswordAuthenticationToken(
                accessToken.getUsername(), null, accessToken.getAuthorities());
    }
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        log.info("Successfully authentication for the request {}",
                request.getRequestURI());
    ...
    private String extractAuthorizationHeaderAsString(
        ...
        try {
            ...
            throw new InvalidTokenException(
                    "There is no Authorization header in a request", ex);
        }
    }
}